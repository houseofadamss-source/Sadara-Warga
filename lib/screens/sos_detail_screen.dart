...
class SOSDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: const Color(0xFFFEF2F2), // Merah sangat muda (Emergency theme)
      appBar: AppBar(
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    padding: const EdgeInsets.all(24),
                    decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(32), boxShadow: [BoxShadow(color: Colors.red.withValues(alpha: 0.05), blurRadius: 20)]),
                    child: Column(
                      children: [
